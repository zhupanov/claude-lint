...
Claude Lint ships **102 rules** organized into 9 categories:
...
| Skills | S | 55 | Skill frontmatter, naming, descriptions, body content, security |
...
| **Plugin** | `.claude-plugin/` directory exists | All 102 rules including manifest, agents, hygiene, and plugin-only S-rules |
...
+-- rules.rs             # Central LintRule enum (102 rules, codes, names)
...
+-- validators/
    ...
    +-- skill_content/   # S009-S055: name, description, body, MCP, security checks
