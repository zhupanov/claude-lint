...
- **100 lint rules** across 9 categories (Manifest, Hooks, Skills, Agents,
...
Claude Lint ships **101 rules** organized into 9 categories:
...
| Skills | S | 54 | Skill frontmatter, naming, descriptions, body content, security |
...
| **Plugin** | `.claude-plugin/` directory exists | All 101 rules including manifest, agents, hygiene, and plugin-only S-rules |
...
+-- rules.rs             # Central LintRule enum (101 rules, codes, names)
...
+-- validators/
    ...
    +-- skill_content/   # S009-S054: name, description, body, MCP, security checks
