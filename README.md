...
Claude Lint ships **103 rules** organized into 9 categories:
...
| Skills | S | 56 | Skill frontmatter, naming, descriptions, body content, security |
...
| **Plugin** | `.claude-plugin/` directory exists | All 103 rules including manifest, agents, hygiene, and plugin-only S-rules |
...
+-- rules.rs             # Central LintRule enum (103 rules, codes, names)
...
+-- validators/
    ...
    +-- skill_content/   # S009-S056: name, description, body, MCP, security checks
